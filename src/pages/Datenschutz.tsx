    ...
    >
      ...
      <Stack gap={3} sx={{ maxWidth: "1000px", textAlign: "justify" }}>
        ...
        <Typography variant="body1">
          ...
          <h2 id="m3">Verantwortliche</h2>Ursula Trahasch, <br /> Beratung |
          Coaching | Supervision | Weiterbildung <br /> An der Stadtmauer 12,
          79346 Endingen am Kaiserstuhl, Deutschland
          <p>E-Mail-Adresse: kontakt@ursula-trahasch.de</p>
          ...
          <p>
            ...
            BDSG enthält insbesondere Spezialregelungen zum Recht auf Auskunft,
          ...
          <p>
            ...
            gesetzlichen Vorgaben. Sofern das Datenschutzniveau in dem Drittland
            mittels eines Angemessenheitsbeschlusses anerkannt wurde Art. 45
            DSGVO, dient dieser als Grundlage des Datentransfers. Im Übrigen
            ...
            Einwilligung oder im Fall vertraglicher oder gesetzlich
            ...
            Anbietern aus dem Drittland mit, wobei die Angemessenheitsbeschlüsse
            als Grundlagen vorrangig gelten. Informationen zu Drittlandtransfers
            ...
            <li>
              ...
              <ul>
                <li>
                  ...
                  Buchungsbelege und Rechnungen § 147 Abs. 3 i. V. m. Abs. 1 Nr.
                  1, 4 und 4a AO, § 14b Abs. 1 UStG, § 257 Abs. 1 Nr. 1 u. 4,
                  Abs. 4 HGB.
                </li>
                <li>
          ...
          <p>
            ...
            Hinblick auf die Kommunikation mit den Vertragspartnern oder
            vorvertraglich, etwa zur Beantwortung von Anfragen.
          </p>
          <p>
            Wir verwenden diese Daten, um unsere vertraglichen Verpflichtungen
            zu erfüllen. Dazu gehören insbesondere die Pflichten zur Erbringung
            der vereinbarten Leistungen, etwaige Aktualisierungspflichten und
            Abhilfe bei Gewährleistungs- und sonstigen Leistungsstörungen.
            Darüber hinaus verwenden wir die Daten zur Wahrung unserer Rechte
            und zum Zwecke der mit diesen Pflichten verbundenen
            Verwaltungsaufgaben sowie der Unternehmensorganisation. Zudem
            verarbeiten wir die Daten auf Grundlage unserer berechtigten
          ...
          <p>
            ...
            in Onlineformularen, durch besondere Kennzeichnung z.B. Farben bzw.
            Symbole z.B. Sternchen o. Ä., oder persönlich mit.
          </p>
          <p>
            Wir löschen die Daten nach Ablauf gesetzlicher Gewährleistungs- und
            vergleichbarer Pflichten, d. h. grundsätzlich nach vier Jahren, es
            sei denn, dass die Daten in einem Kundenkonto gespeichert werden,
          ...
          <p>
            ...
            Software kennen nicht die tatsächliche Identität der Nutzer, sondern
            nur die zum Zweck der jeweiligen Verfahren in deren Profilen
          ...
          <p>
            ...
            möchten wir Sie auch auf die Informationen zur Verwendung von
          ...
          <ul>
            <li>
              ...
              Nutzerprofilen, wie Berufsfunktion, Land, Branche,
              ...
              z.B. Auskunfts- oder Löschungsanfragen direkt an LinkedIn richten.
              Die Rechte der Nutzer insbesondere das Recht auf Auskunft,
              Löschung, Widerspruch und Beschwerde bei der zuständigen
          ...
          <ul>
            <li>
              ...
              Standortdaten der Nutzer gehören; <strong>Dienstanbieter:</strong>{" "}
